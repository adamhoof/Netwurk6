...
public class RouterPropertiesMenu {
    Dialog<ButtonType> dialog = new Dialog<>();
    TextField macAddressField = new TextField();
    TextField ipAddressField = new TextField();

    public RouterPropertiesMenu() {
    ...
    public void show(RouterProperties routerProperties) {
        macAddressField.setText(routerProperties.getMACaddress());
        ipAddressField.setText(routerProperties.getIPaddress());
        dialog.showAndWait();
    }
}
